srcdir = /say/code/php-src/ext/say
builddir = /say/code/php-src/ext/say
top_srcdir = /say/code/php-src/ext/say
top_builddir = /say/code/php-src/ext/say
EGREP = /bin/grep -E
SED = /bin/sed
CONFIGURE_COMMAND = './configure' '--enable-say'
CONFIGURE_OPTIONS = '--enable-say'
SHLIB_SUFFIX_NAME = so
SHLIB_DL_SUFFIX_NAME = so
ZEND_EXT_TYPE = zend_extension
RE2C = exit 0;
AWK = nawk
shared_objects_say = say.lo
PHP_PECL_EXTENSION = say
PHP_MODULES = $(phplibdir)/say.la
PHP_ZEND_EX =
...
prefix = /say/soft/php
phplibdir = /say/code/php-src/ext/say/modules
phpincludedir = /say/soft/php/include/php
CC = cc
CFLAGS = -g -O2
CFLAGS_CLEAN = $(CFLAGS)
CPP = cc -E
...
EXTENSION_DIR = /say/soft/php/lib/php/extensions/no-debug-non-zts-20170718
PHP_EXECUTABLE = /say/soft/php/bin/php
EXTRA_LDFLAGS =
EXTRA_LIBS =
INCLUDES = -I/say/soft/php/include/php -I/say/soft/php/include/php/main -I/say/soft/php/include/php/TSRM -I/say/soft/php/include/php/Zend -I/say/soft/php/include/php/ext -I/say/soft/php/include/php/ext/date/lib
LFLAGS =
LDFLAGS =
SHARED_LIBTOOL =
